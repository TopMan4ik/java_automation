...
public class Lesson6_22_03_16 extends TestHarness {
    ...
    //TODO: читать про конструкторы, геттеры, сеттеры, this

    //наследование в джаве только от 1-го класса
    //от класса нельзя наследоваться если он final, от метода нельзя...

    /**
     * TODO: создать класс на домашней странице kismia.com
     * TODO: потом наследоваться от домашней на другую и допилить функционала kismia.com/support
     */
